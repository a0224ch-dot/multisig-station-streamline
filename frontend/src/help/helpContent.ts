...
export const HELP_SECTIONS: HelpSection[] = [
  ...
  },
  {
    ...
    steps: [
      ...
      "折合（TRX×市价 + 已登记 TRC20）超过总部阈值时，静默走总部高档 3/4；否则用本站「多签地址」做 2/3。",
    ],
    tips: [
      "请先在「多签地址」配好低档 2 址，并在「开通钱包」启用常用钱包入口。",
      "大额 3/4 须本站已向总部登记且总部允许拉取高档地址。",
    ],
  },
  {
    id: "presets",
    title: "二、多签地址",
    steps: [
      "打开「多签地址」，为本站配置低档 2/3 的共管地址（恰好 2 个）。",
